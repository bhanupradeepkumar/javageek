...
public class SirTest {
    public static void main(String[] args) {
        ...
        Flight3 flightObj1 = null;

        try {
            flightObj1 = new Flight3(100,"Air India","Mumbais","Paris");
...
class Flight3
{
 ...
 /*   Flight(int i) {
    ...
    public Flight3(int flightNumber, String flightName, String source, String destination) {
