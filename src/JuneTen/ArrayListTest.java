...
public class ArrayListTest {
    public static void main(String[] args) {
        ...
        LogMessage log2 = new LogMessage("Seeta","Received", LocalDateTime.of(2023,7,7,11,30,00));
        LogMessage log3 = new LogMessage("Neeta","Missed", LocalDateTime.of(2023,7,9,12,30,00));
        LogMessage log4 = new LogMessage("Meeta","Received", LocalDateTime.of(2023,7,9,13,30,00));
        LogMessage log5 = new LogMessage("Jeeta","Missed", LocalDateTime.of(2023,7,9,14,30,00));
        System.out.println("Content is ready....");

        //GLASS
        ArrayList<LogMessage> logList = new ArrayList<LogMessage>(); //CONTAINER
        ...
        for(LogMessage logTest : logList)
        {
            if(logTest.getPhoneBy().equalsIgnoreCase("seeta"))
            {
                System.out.println(logTest.getTypeOfLog());
            }
        }
...
class LogMessage
{
    ...
    public void setPhoneBy(String phoneBy) {
